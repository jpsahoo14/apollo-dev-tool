...
export type LaunchListWithExtraFieldsQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchListWithExtraFieldsQuery = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', id?: string | null, details?: string | null, mission_id?: Array<string | null> | null, mission_name?: string | null, launch_year?: string | null, launch_success?: boolean | null, is_tentative?: boolean | null } | null> | null };

export type LaunchListQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchListQuery = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', id?: string | null, details?: string | null, mission_id?: Array<string | null> | null, mission_name?: string | null, launch_year?: string | null } | null> | null };


export const LaunchListWithExtraFieldsDocument = gql`
...
/**
 * __useLaunchListWithExtraFieldsQuery__
 *
 * To run a query within a React component, call `useLaunchListWithExtraFieldsQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchListWithExtraFieldsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchListWithExtraFieldsQuery({
 *   variables: {
 *   },
 * });
 */
export function useLaunchListWithExtraFieldsQuery(baseOptions?: Apollo.QueryHookOptions<LaunchListWithExtraFieldsQuery, LaunchListWithExtraFieldsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LaunchListWithExtraFieldsQuery, LaunchListWithExtraFieldsQueryVariables>(LaunchListWithExtraFieldsDocument, options);
      }
export function useLaunchListWithExtraFieldsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchListWithExtraFieldsQuery, LaunchListWithExtraFieldsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaunchListWithExtraFieldsQuery, LaunchListWithExtraFieldsQueryVariables>(LaunchListWithExtraFieldsDocument, options);
        }
export type LaunchListWithExtraFieldsQueryHookResult = ReturnType<typeof useLaunchListWithExtraFieldsQuery>;
export type LaunchListWithExtraFieldsLazyQueryHookResult = ReturnType<typeof useLaunchListWithExtraFieldsLazyQuery>;
export type LaunchListWithExtraFieldsQueryResult = Apollo.QueryResult<LaunchListWithExtraFieldsQuery, LaunchListWithExtraFieldsQueryVariables>;
